    ...
    'grant_types'             => [
        'password'      => [
            ...
            'callback'         => function ($username, $password) {
                $userService = app(Nettineuvoja\Access\App\UserService::class);
                $authService = app(Nettineuvoja\Access\App\AuthService::class);

                /** @var Nettineuvoja\Access\Domain\Model\User $user */
